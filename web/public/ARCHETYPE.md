...
These are evidence-based, revisable interaction hypotheses. They are not diagnoses or established facts.

_No supported hypotheses yet._

## Turn-level behavioral modes

These modes are selected from the current request and recent style drift. They are not user personality claims and are not persisted as facts.
