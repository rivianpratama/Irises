...
ALL deep work (research, files, memory) to the OpenClaw gateway it is pointed at. OpenClaw stays
completely unmodified; Irises talks to it only over the Gateway WebSocket `agent` RPC using the
