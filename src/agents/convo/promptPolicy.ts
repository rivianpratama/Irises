...
export const PROMPT_BUDGET: Record<BudgetKey, number> = {
  ...
  owed: 720,                  // 709 — owed asks (memory/owedAsks.ts) at the store's cap on the thread-offer fixture: OWED_MAX asks each at TURNED_DOWN_ASK_CHARS. NEW with the autonomy round (2026-09-25).
