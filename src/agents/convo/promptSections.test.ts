...
//
// GOLDEN_TAIL has since been regenerated ONCE, deliberately: P1 collapsed the behaviour anchor from
// fourteen lines to six (1,659 → 699 chars), deleting the eight lines that restated a rule owning a
// section of its own — the bubble numbers, "answer first", predict/probe, the tease line, "you
// concede to information", "settled ground is settled", "a greeting gets a greeting". The JSON
// anchor's bytes did not move. Nothing else in this file was touched, so the diff on that one line
